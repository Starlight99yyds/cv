...
class Tester:
    def __init__(self, model_path, test_data_dir):
        ...
        self.test_dataset = MedicalSegmentationDataset(
            os.path.join(test_data_dir, 'val - 副本/images'),
            os.path.join(test_data_dir, 'val - 副本/labels')
        )
...
def main():
    ...
    sample_img = './data/val - 副本/images/CHNCXR_0660_1.png'
    sample_gt = './data/val - 副本/labels/CHNCXR_0660_1.png'
